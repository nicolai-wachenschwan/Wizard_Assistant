...
Dieses Repository enthält den Code für einen KI-basierten Assistenten für das Kartenspiel "Wizard". Der Assistent ist in der Lage, sowohl Empfehlungen für das abzugebende Gebot (`Bid Recommendation`) als auch für die auszuspielende Karte (`Card Recommendation`) zu geben.
...
graph TD
    ...
    C --> D[Loop: N verschiedene Verteilungen der unbekannten Karten];
